...
- A second view of the website for readers, which displays the posts according to class
and department, which is easier to read. Readers will be able to navigate to a class
page (indexed according to department and class number), and see the reviews that
